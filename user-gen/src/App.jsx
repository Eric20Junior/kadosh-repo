...
function App() {
  ...
  useEffect(() => {
    const getUser = async () => {
      try {
        ...
        setUsers(data); // Set state with fetched data
  ...
  return (
    <>
      <div className="flex justify-center items-center flex-wrap mb-4 mt-10 space-x-2">
        <input
          type="text"
      ...
      <div className="flex justify-center flex-wrap">
        {filteredUsers.map((user, index) => (
          <div key={index} className="m-10 w-[20rem]">
            <div className="rounded-xl border bg-white px-4 pt-8 pb-10 shadow-lg">
              <div className="relative mx-auto w-[11rem] rounded-full">
                <span className="absolute right-0 m-5 h-3 w-3 rounded-full bg-green-500 ring-2 ring-green-300 ring-offset-2"></span>
                <img
